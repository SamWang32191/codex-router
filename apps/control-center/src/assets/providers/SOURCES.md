...
| `cerebras.png` | Cerebras | https://www.cerebras.ai/ | https://cdn.sanity.io/images/e4qjo92p/production/e7a55ae5ab7e2c4fdfd4e66a51f628d1f2f44207-967x967.png |
| `groq.svg` | Groq | https://groq.com/ | https://groq.com/favicon.svg |
| `fireworks.svg` | Fireworks AI | https://fireworks.ai/ | https://fireworks.ai/icon0.svg |
| `together.png` | Together AI | https://www.together.ai/ | https://cdn.prod.website-files.com/69654e88dce9154b5f1206dd/69a59cff65ed0f267dd2fbe8_touchicon.png |
| `siliconflow.png` | SiliconFlow | https://www.siliconflow.com/ | https://framerusercontent.com/images/zeLtigS2vdf9RnjlY87AvwUBckM.png |
| `zai.svg` | Z.ai and GLM models | https://z.ai/ | https://z-cdn.chatglm.cn/z-ai/static/logo.svg |
| `cline.png` | ClinePass and Cline | https://cline.bot/ | https://cline.bot/assets/branding/favicons/favicon-256x256.png |
...
| `nvidia.svg` | NVIDIA NIM and Nemotron | https://www.nvidia.com/en-us/about-nvidia/legal-info/logo-brand-usage/ | https://cdn.simpleicons.org/nvidia |
...
curated models use the control center's deterministic labeled monogram fallback.
